...
# Helper: Credenciales de la escuela Kemper Urgate 
def kemper_credentials():
    return [
...
# ============================================================================
def factura_ce_ingreso_con_carta_porte_31_por_valores():
    print("=== 1. Factura CE Ingreso Con Carta Porte 31 ===")
    ...
    invoice = Invoice(
        ...
        issuer=InvoiceIssuer(
            ...
            tax_regime_code="601",
            tax_credentials=kemper_credentials(),
        ),
...
# ============================================================================
def factura_ce_ingreso_diferentes_monedas_por_valores():
    print("=== 2. Factura CE Ingreso Diferentes Monedas ===")
...
# ============================================================================
def factura_ce_kit_parte_por_valores():
    print("=== 3. Factura CE Kit Parte ===")
...
# ============================================================================
def factura_ce_receptor_extranjero_por_valores():
    print("=== 4. Factura CE Receptor Extranjero ===")
...
# ============================================================================
def factura_ce_receptor_nacional_por_valores():
    print("=== 5. Factura CE Receptor Nacional ===")
...
# ============================================================================
def factura_ce_traslado_con_carta_porte_31_por_valores():
    print("=== 6. Factura CE Traslado Con Carta Porte 31 ===")
...
# ============================================================================
def factura_ce_traslado_traslado_mercancia_propia_por_valores():
    print("=== 7. Factura CE Traslado Traslado Mercancia Propia ===")
...
# ============================================================================
def factura_ce_traslado_traslado_por_valores():
    print("=== 8. Factura CE Traslado Traslado ===")
...
# ============================================================================
def factura_ce_unidades_de_medida_no_equivalentes_por_valores():
    print("=== 9. Factura CE Unidades De Medida No Equivalentes ===")
...
if __name__ == "__main__":
    # factura_ce_ingreso_con_carta_porte_31_por_valores()
    # factura_ce_ingreso_diferentes_monedas_por_valores()
    # factura_ce_kit_parte_por_valores()
    # factura_ce_receptor_extranjero_por_valores()
    # factura_ce_receptor_nacional_por_valores()
